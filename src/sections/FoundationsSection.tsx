            ...
            return (
              <button
                ...
                className={`
                  ...
                  bg-slate-900/40
                  border-slate-800/80
                  hover:border-sky-500/60 hover:bg-slate-900/70
                      ...
                      {caseStudy && (
                        <div className="pt-2">
                          <span
                            ...
                            className="inline-flex items-center gap-1 text-[10px] md:text-[11px] px-2.5 py-1 rounded-full border border-sky-500/60 text-sky-300 hover:bg-sky-500/10 transition cursor-pointer"
                          >
                            <svg
                              width="14"
                              height="14"
