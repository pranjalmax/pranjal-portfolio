    ...
    <section id="playground" className="pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {/* 1. Signal Modes */}
          <div className="md:col-span-1 rounded-2xl border border-slate-800/80 bg-slate-950/60 p-3 flex flex-col gap-2 shadow-[0_16px_40px_rgba(15,23,42,0.82)]">
          ...
          {/* 2. MAX Prompt Kit */}
          <div className="md:col-span-1 rounded-2xl border border-slate-800/80 bg-slate-950/60 p-3 flex flex-col gap-2">
            ...
            <div className="mt-1 flex flex-col gap-1.5">
              {prompts.map((p) => (
                <button
                  ...
                  className="group text-left text-[9px] px-2 py-1 rounded-lg bg-slate-900/85 border border-slate-700/80 hover:border-sky-400/70 hover:bg-slate-900/100 transition-all flex items-center gap-1.5"
                >
              ...
              {tags.map((tag, idx) => {
                ...
                return (
                  <button
                    ...
                    className="px-2 py-1 rounded-full bg-slate-900/85 border border-slate-700/85 text-[9px] text-slate-300 hover:text-sky-50 hover:border-sky-500/60 transition-all flex items-center gap-1.5"
                  >
                    <span
