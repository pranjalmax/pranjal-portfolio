    ...
    <section id="hero" className="pt-10 pb-10 relative">
      <div className="flex flex-col md:flex-row items-stretch gap-6 md:gap-8">
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <ScrollReveal delay={0.6}>
            <div className="flex flex-wrap gap-3 mt-2">
              <MagneticButton
                href="#ai-lab"
                className="px-4 py-2 rounded-full bg-sky-500 text-[10px] md:text-[12px] font-medium hover:bg-sky-400 hover:shadow-[0_0_26px_rgba(56,189,248,0.55)] transition inline-block text-white"
              >
                Explore AI Lab First
              </MagneticButton>
              <MagneticButton
                href="#contact"
                className="px-4 py-2 rounded-full border border-slate-600/80 text-[10px] md:text-[12px] font-medium text-slate-200 hover:border-sky-400 hover:text-sky-400 transition inline-block"
              >
                Contact
              </MagneticButton>
            </div>
        ...
        <div className="w-full md:w-[260px] lg:w-[280px] flex">
          <ScrollReveal delay={0.5} direction="left" width="100%">
            <ThreeDNode>
              <div
                className="
                  relative w-full
